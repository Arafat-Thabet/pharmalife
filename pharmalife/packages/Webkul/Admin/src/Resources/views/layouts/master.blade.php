...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('themes/velocity/assets/css/font-awesome.min.css') }}" />
    ...
    <body @if (core()->getCurrentLocale() && isset(core()->getCurrentLocale()->direction) && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
