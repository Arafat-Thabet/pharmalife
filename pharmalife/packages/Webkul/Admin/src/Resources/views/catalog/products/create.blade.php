            ...
            <div class="page-content">
                ...
                <accordian :title="'{{ __('admin::app.catalog.products.general') }}'" :active="true">
                    <div slot="body">
                        ...
                        <div style="display: none;" class="control-group" :class="[errors.has('sku') ? 'has-error' : '']">
                           ...
                           <!--  <input type="text" v-validate="{ required: true, regex: /^[a-z0-9]+(?:-[a-z0-9]+)*$/ }" class="control" id="sku" name="sku" value="{{ request()->input('sku') ?: old('sku') }}" data-vv-as="&quot;{{ __('admin::app.catalog.products.sku') }}&quot;"/> -->
                            <input type="hidden" v-validate="{ required: true, regex: /^[a-z0-9]+(?:-[a-z0-9]+)*$/ }" class="control" id="sku" name="sku" value="{{$rand_sku}}" data-vv-as="&quot;{{ __('admin::app.catalog.products.sku') }}&quot;"/>
