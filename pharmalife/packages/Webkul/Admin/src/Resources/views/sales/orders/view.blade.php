            ...
            <tabs>
                ...
                <tab name="{{ __('admin::app.sales.orders.info') }}" :selected="true">
                    <div class="sale-container">
                        ...
                        @if (false && $order->billing_address || $order->shipping_address)
                            <accordian  :title="'{{ __('admin::app.sales.orders.address') }}'" :active="true">
                                <div slot="body" >
                                    ...
                                    @if ($order->shipping_address)
                                        <div class="sale-section" style="display: none;">
                                            <div class="secton-title">
                        ...
                        <accordian style="display: none;" :title="'{{ __('admin::app.sales.orders.payment-and-shipping') }}'" :active="true">
                            <div slot="body" style="display: none;">
                ...
                <tab style="display: none;" name="{{ __('admin::app.sales.orders.invoices') }}">
                ...
                <tab style="display: none;" name="{{ __('admin::app.sales.orders.shipments') }}">
                ...
                <tab style="display: none;" name="{{ __('admin::app.sales.orders.refunds') }}">

                    <div style="display: none;" class="table" style="padding: 20px 0">
                        <table>
                            <thead>
                                <tr>
