...
return [
    ...
    'layouts' => [
        ...
        'shipments' => 'الشحنات',
        'invoices' => 'الفواتير',
        'catalog' => 'كاتلوج المنتجات',
        'products' => 'المنتجات',
        'categories' => 'الفئات',
        'attributes' => 'خصائص المنتج',
        'attribute-families' => 'مجموعة خصائص المنتج ',
        'customers' => 'زبائن/عملاء',
        'groups' => 'المجموعات',
        'reviews' => 'مراجعات',
        ...
        'inventory-sources' => 'مصادر المخازن',
        'channels' => 'قنوات البيع',
        'users' => 'المستخدمون',
        'roles' => 'ادوار المستخدمين',
        'sliders' => 'ادارة السلايدر',
        'taxes' => 'الضرائب',
    ...
    'acl' => [
        ...
        'categories' => 'الفئات',
        'attributes' => 'الصفات',
        'attribute-families' => 'وصف مجموعة الخصائص',
        'customers' => 'زبائن/عملاء',
        'groups' => 'المجموعات',
        'reviews' => 'مراجعات',
        'newsletter-subscriptions' => 'الاشتراك في الرسالة الإخبارية',
        ...
        'currencies' => 'العملات',
        'exchange-rates' => 'أسعار الصرف',
        'inventory-sources' => 'مصادر المخزن',
        'channels' => 'قنوات البيع',
        'users' => 'المستخدمون',
        'roles' => 'الأدوار',
        'sliders' => 'سلايدرز',
    ...
    'dashboard' => [
        ...
        'order-count' => ':count الطلبات',
        'revenue' => 'الإيرادات :مجموع',
        'stock-threshold' => 'بداية المخزون',
        'qty-left' => ':qty يسار',
    ],
    ...
    'datagrid' => [
        ...
        'per-channel'  => 'قائم على قناة البيع',
        'position'     => 'موضع',
        'locale'       => 'لغة',
        'hostname' => 'اسم المضيف',
        ...
        'attribute-family' => 'مجموعة خصائص المنتج',
        'starts-from' => 'يبدأ من',
        'ends-till' => 'ينتهي حتى',
        'per-cust' => 'لكل عميل',
    ...
    'users' => [
        'forget-password' => [
            ...
            'header-title' => 'استعادة كلمة المرور',
        ...
        'sessions' => [
            ...
            'email' => 'البريد الإلكتروني',
            'password' => 'كلمه السر',
            'forget-password-link-title' => 'هل نسيت كلمة السر ؟',
            'remember-me' => 'تذكرني',
    ...
    'sales' => [
        'orders' => [
            ...
            'item-ordered' => '(:qty_ordered) طلبت ',
            'item-invoice' => '(:qty_invoiced) فاتورة',
            'item-shipped' =>'(:qty_shipped) تم شحنها',
            'item-canceled' => '(:qty_canceled)ملغاة',
            'item-refunded' => '(:qty_refunded)  رفضت',
            'price' => 'السعر',
            'total' => 'المجموع',
            ...
            'refunds' => 'المبالغ المستردة',
            'refunded' => 'تم رد الأموال',
            'comment-added-success' => 'تم اضافة التعليق بنجاح.',
            'comment' => 'تعليق',
            'submit-comment' => 'ارسال التعليق ',
            'notify-customer' => 'أشعار العميل ',
        ],
    ...
    'catalog' => [
        'products' => [
            ...
            'is-required' => 'اجباري',
            'select' => 'تحديد',
            'radio' => 'زر اختيار محدد',
            'checkbox' => ' اختيار',
            'multiselect' => 'تحديد متعدد',
            'new-option' => 'خيار جديد',
            'is-default' => 'افتراضي',
            "customer-group"=>"مجموعات العملاء",
            "qty"=>"الكمية",
            'price' => 'السعر',
            "add-group-price"=>"اضف سعر خاص لمجموعة من العملاء",
        ],

        'attributes' => [
            'title' => 'الصفات/خصائص المنتج',
    ...
    'settings' => [
        ...
        'inventory_sources' => [
            'title' => 'مصادر المخزن',
            'add-title' => 'إضافة عنوان المخزن ',
            'edit-title' => 'تعديل مصدر المخزن',
            'save-btn-title' => 'احفظ مصدر المخزن',
            'general' => 'ألف-لمحة عامة',
            'code' => 'الشفرة',
            'name' => 'اسم',
            'description' => 'الوصف',
        ...
        'channels' => [
            'title' => ' قناة البيع',
            'add-title' => 'أضف قناة بيع',
            'edit-title' => 'تعديل قنات البيع',
        ...
        'sliders' => [
            'title' => 'سلايدر',
            'name' => 'الاسم',
            'add-title' => 'أنشئ  عنصر سلايدر جديد',
            'edit-title' => 'تعديل سلايدر',
            'save-btn-title' => 'حفظ سلايدر',
            'general' => 'بيانات عامة',
            'image' => 'صورة',
            'content' => 'المحتوى',
            'channels' => 'البيع قناة',
            'created-success' => 'تم انشاء سلايدر بنجاح',
            'created-fault' => 'خطأ في إنشاء سلايدر',
            'update-success' => 'تم تحديث عنصر السلايدر بنجاح',
            'update-fail' => 'السلايدر لا يمكن تعديلة',
            'delete-success' => 'لا يستطيع حذف الأخير عنصر',
            'delete-fail' => 'تم حذف السلايدر  بنجاح'
        ],
        ...
        'tax-categories' => [
            ...
            'select-channel' => 'اختر قناة البيع',
            'name' => 'اسم',
            'code' => 'الشفرة',
            'description' => 'الوصف',
            'select-taxrates' => 'انتق ضريبة المعدلات',
    ...
    'admin' => [
        ...
        'system' => [
            ...
            'products' => 'منتجات',
            'guest-checkout' => ' اعتماد الطلب لزائر الموقع',
            'allow-guest-checkout' => 'السماح باعتماد طلب زائر الموقع',
            'allow-guest-checkout-hint' => 'تلميح: في حالة تشغيله ، يمكن تكوين هذا الخيار لكل منتج على وجه التحديد',
            'review' => 'مراجعة',
            'allow-guest-review' => 'السماح بمراجعة زائر الموقع',
            'inventory' => 'المخزون',
            'stock-options' => 'خيارات الأسهم',
            'allow-backorders' => 'السماح بالطلب بسالب المخزون ',
            'customer' => 'العملاء',
            'settings' => 'الإعدادات',
            'address' => 'عنوان',
