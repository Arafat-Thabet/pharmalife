...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
       ...
       /* Event::listen('bagisto.admin.catalog.product.edit_form_accordian.General.before', function($viewRenderEventManager) {
            $viewRenderEventManager->addTemplate('admin::catalog.products.edit_form_accordian.General.before');
        });*/
        Event::listen([
