...
return [
    ...
    'header' => [
        'title' => 'الحساب',
        'dropdown-text' => 'إدارة سلة التسوق ، الطلبات قائمة الأمنيات',
    ...
    'customer' => [
        ...
        'account' => [
            ...
            'wishlist' => [
                ...
                'deleteall' => 'احذف الكل',
                'moveall' => 'نقل الكل إلى سلة التسوق',
    ...
    'products' => [
        ...
        'add-to-cart' => 'أضف إلى سلة الشراء',
        'book-now' => 'احجز الآن',
        'buy-now' => 'اشتر الآن',
        'whoops' => 'خطأ!',
        'quantity' => 'الكمية',
    ...
    'checkout' => [
        'cart' => [
            'integrity' => [
                'missing_fields' =>'إنتهاك سلامة نظام السلة ، بعض الحقول المطلوبة مفقودة',
                'missing_options' =>'إنتهاك سلامة نظام السلة ، الخيارات مفقودة لمنتج قابل للتهيئة',
            ...
            'add-config-warning' => 'الرجاء اختيار الخيار قبل إضافة إلى السلة',
            'quantity' => [
                'quantity' => 'الكمية',
                'success' => 'العنصر(ق) من السلة تم تحديثه بنجاح',
            ...
            'item' => [
                'error_remove' => 'لا عناصر لإزالتها من السلة',
                'success' => 'تم بنجاح إضافة العنصر إلى السلة',
                'success-remove' => 'تم إزالة العنصر بنجاح من السلة',
                'error-add' => 'لا يمكن إضافة العنصر إلى السلة ، رجاء حاول مرة أخرى ',
                'inactive' => 'An item is inactive and was removed from cart',
                'inactive-add' => 'Inactive item cannot be added to cart',
            ],
            'quantity-error' => 'الكمية المطلوبة غير متوفرة',
            'cart-subtotal' => 'اجمالي  الطلب',
        ...
        'success' => [
            ...
            'info' => 'سنرسل لك بريدا الكترونيا ، تفاصيل طلباتك   '
        ]
    ],
