...
use Webkul\Attribute\Repositories\AttTranslate as AttTranslate;
class ProductController extends Controller
{
    ...
    )
    {
        ...
        $this->AttTranslate=$AttTranslate;
    }
    ...
    public function create()
    {
        ...
        $rand_sku =time().rand(1,1000);
       
        //$rand_sku_var=['rand_sku'=>$rand_sku];
        ...
        return view($this->_config['view'], compact('families', 'configurableFamily','rand_sku'));
    }
    ...
    public function edit($id)
    {
        ...
        $att_translate=$this->AttTranslate;
        $categories = $this->categoryRepository->getCategoryTree();

        $inventorySources = $this->inventorySourceRepository->findWhere(['status' => 1]);

        return view($this->_config['view'], compact('product', 'categories', 'inventorySources',"att_translate"));
    }
